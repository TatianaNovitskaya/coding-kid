    ...
    return (
        <>
            <section id={"home"} className={"bg-[#116CFF]"}>
                <div className={"container mx-auto px-4 flex flex-col-reverse lg:flex-row-reverse justify-between items-center py-[5.62rem] xl:py-[9.62rem]"}>
                    <div className={"w-full lg:w-1/2 text-white text-center lg:text-left"}>
                        ...
                        <p className={"mt-4 w-full lg:w-[85%] text-[1rem] leading-[1.75rem]"}>At Kids&apos; Coding Adventure, we
                            ...
                            possibilities!</p>
                        <Link href={"/#contacts"}
                            className={"mr-[1rem] inline-block lg:mr-[1.5rem] mt-[2rem] py-[0.81rem] px-[1.88rem] lg:py-[0.94rem] lg:px-[2.31rem] bg-white text-[#116CFF] font-bold rounded-[0.625rem]"}>Book
                            a Class
                        </Link>
                        <Link href={"#programs"}
                              className={"py-[0.81rem] inline-block px-[1.88rem] lg:py-[0.94rem] lg:px-[2.31rem] border border-white text-white font-medium rounded-[0.625rem]"}>Learn
                            more</Link>
                    </div>
