...
export default function Footer() {
    return (
        <>
            <footer className={" bg-[#00235C]"}>
                <div className={"container px-4 mx-auto  py-[5.5rem] relative"}>
                    <div className="flex flex-col lg:flex-row justify-between items-center relative">
                        ...
                        <div className="z-10">
                            ...
                            <div className="">
                                <address className={"text-white my-[1.88rem] not-italic"}>
                                    ...
                                    <Link href={"mailto:webmaster@somedomain.com"}
                        ...
                        <nav className={"hidden lg:block"}>
                            <ul className={"flex text-white text-base "}>
                                <li className={"mr-[5.75rem]"}><Link href={"#home"}
                                                                     className={"text-[#116CFF] text-[1.125rem] font-medium"}>Company</Link>
                                    <ul>
                                ...
                                <li className={"mr-[5.75rem]"}><Link href={"#programs"}
                                                                     className={"text-[#116CFF] text-[1.125rem] font-medium"}>Programs</Link>
                                    <ul>
                                        <li className={"mt-[1.28rem]"}><Link href={"#programs"}>Beginner Class</Link>
                                        </li>
                                        <li className={"mt-[1.28rem]"}><Link href={"#programs"}>Intermediate
                                            Class</Link></li>
                                        <li className={"mt-[1.28rem]"}><Link href={"#programs"}>Expert Class</Link></li>
                                    </ul>
                                </li>
                                <li className={"lg:mr-0 mr-[5.75rem]"}><Link href={"#contacts"}
                                                                             className={"text-[#116CFF] text-[1.125rem] font-medium"}>Information</Link>
                                    <ul>
                                        <li className={"mt-[1.28rem]"}><Link href={"#programs"}>Registration</Link></li>
                                        <li className={"mt-[1.28rem]"}><Link href={"#programs"}>Free Trial Class</Link>
                                        </li>
